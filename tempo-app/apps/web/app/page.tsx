    ...
    <AppLayout>
      <div className="space-y-6">
        <header className="flex justify-between items-center mb-6">
          <div>
            <p className="text-primary font-medium text-xs mb-1 uppercase tracking-wider">
            ...
            <div className="flex items-center gap-6">
              <div className="relative w-24 h-24 flex-shrink-0">
                ...
                <div className="absolute inset-0 flex items-center justify-center flex-col">
                  <span className="text-2xl font-bold text-foreground">{doneToday}</span>
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  {doneToday === totalToday && totalToday > 0 ? "All done for today!" : "Keep going, you're doing great!"}
                </p>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Card className="glass border-border/50">
            <CardContent className="p-4 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-2xl font-bold">{inboxTasks.length}</span>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/today" className="text-xs text-primary font-medium hover:underline">View all</Link>
          </div>
