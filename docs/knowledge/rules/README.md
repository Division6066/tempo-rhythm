...
| `tempo-openrouter.mdc` | *(removed — was OpenRouter)* | **Current:** LLM calls use Mistral API via `convex/lib/ai_router.ts`; see HARD_RULES §2 and `.cursor/rules/tempo-hard-rules.mdc`. |
