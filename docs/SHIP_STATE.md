...
| CI typecheck + lint | `shipped-and-running` | `.github/workflows/ci.yml`, green on PRs | 2026-06-14 |
| CI unit tests (`bun test`) | `coded` | Root script exists; CI Test job still `continue-on-error` | 2026-06-14 |
| CI forbidden-tech + RAM-only + design-token scans | `planned` | Scripts not in root `package.json`; CI logs notices only | 2026-06-14 |
| CI secret scan (Gitleaks + TruffleHog) | `shipped-and-running` | `.github/workflows/security.yml` | 2026-06-14 |
