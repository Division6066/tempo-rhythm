...
import { BrainCircuit, Sparkles, Clock, Zap, ArrowRight, CheckCircle } from "lucide-react";
  ...
  const steps = [
    ...
    <div key="step-3" className="flex flex-col items-center justify-center text-center space-y-6 mt-16">
      ...
      <Button 
        ...
        className="mt-8 w-full max-w-xs h-14 text-lg bg-teal-500 hover:bg-teal-400 text-white rounded-2xl shadow-lg shadow-teal-500/20"
      >
