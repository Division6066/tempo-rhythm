      ...
      <section className="px-6 pt-16 pb-24 max-w-[var(--container-tempo)] mx-auto">
        <div className="max-w-3xl flex flex-col gap-6">
          ...
          <p className="text-h3 text-muted-foreground leading-relaxed font-serif">
            An overwhelm-first daily planner for ADHD, autistic, and neurodivergent brains. Never
            shaming. Always gentle.
          </p>
        ...
        <SoftCard tone="sunken" className="mt-12 max-w-2xl">
          <div className="flex flex-col gap-2">
            ...
            <span className="text-small text-muted-foreground">
              The full click-through prototype is scaffolded across 42 web routes. Press{" "}
              <code className="rounded bg-card px-1.5 py-0.5 border border-border-soft font-mono">
                ⌘K
              </code>{" "}
              inside the app to jump to any screen. Real JSX content ships in T-F005 tickets.
            </span>
          </div>
        </SoftCard>
      </section>
