...
export const activeSessionStorageKey = "tempo.sessionPlayer.active.v1";
export const sessionLogStorageKey = "tempo.sessionPlayer.log.v1";
...
export function startSession(routine: Routine, now: number): SessionPlayerState {
  return {
...
export function resumeSession(state: SessionPlayerState, now: number): SessionPlayerState {
