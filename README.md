...
- **AI routing (implemented):** Mistral API via native `fetch` in Convex actions (`convex/lib/ai_router.ts`). No OpenRouter or direct provider SDKs (see `docs/HARD_RULES.md` §6).
...
- [`docs/REVENUECAT_SETUP.md`](./docs/REVENUECAT_SETUP.md) — mobile entitlements and API keys.
