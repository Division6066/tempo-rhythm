...
- **Package manager:** Bun (`bun@1.3.9`, `bun.lock` committed)
...
- [`docs/CI.md`](./docs/CI.md) — GitHub Actions jobs, blocking vs notice-only checks.
- [`docs/REVENUECAT_SETUP.md`](./docs/REVENUECAT_SETUP.md) — mobile paywall keys, EAS project, env vars.
- [`docs/AGENT_AUTOMATION_RUNBOOK.md`](./docs/AGENT_AUTOMATION_RUNBOOK.md) — Cyrus worktrees, Cursor background agents, risk tiers.
