...
- **AI routing (implemented):** Mistral API via `convex/lib/ai_router.ts` — `fast` / `balanced` / `deep` tiers (see `docs/HARD_RULES.md` §6)
...
- [`docs/CI.md`](./docs/CI.md) — what GitHub Actions runs (blocking vs notice-only).
