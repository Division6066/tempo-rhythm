...
- **AI routing:** Mistral API via `convex/lib/ai_router.ts` (`fast` / `balanced` / `deep` tiers). See `docs/HARD_RULES.md` §6.
...
- [`docs/REVENUECAT_SETUP.md`](./docs/REVENUECAT_SETUP.md) — mobile paywall + Convex webhook wiring.
